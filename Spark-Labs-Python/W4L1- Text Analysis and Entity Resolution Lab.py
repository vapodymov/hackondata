# Databricks notebook source exported at Sun, 18 Sep 2016 17:18:14 UTC
# MAGIC %md
...
# MAGIC 
# MAGIC Based on the EdX Course by DataBricks -- Big Data Analysis with Apache Spark
...
# MAGIC * Other - your ideas
# MAGIC 
# MAGIC #### Include any of the proposed improvements in the model, how does it compare?

# COMMAND ----------

# MAGIC %md
# MAGIC * Using different models and types of classifiers
# MAGIC 
# MAGIC E.g., [Cost-Effective Crowdsourced Entity Resolution](http://dbgroup.cs.tsinghua.edu.cn/ligl/papers/sigmod16-crowder.pdf)
