# Databricks notebook source exported at Sun, 18 Sep 2016 17:17:10 UTC
# MAGIC %md
...
# MAGIC %md
# MAGIC Before beginning this lab exercise, please watch the lectures for modules one and two.  (same content as last week) 
# MAGIC They can be found in:
# MAGIC    - https://databricks-prod-cloudfront.cloud.databricks.com/public/4027ec902e239c93eaaa8714f173bcfc/2799933550853697/1090810279281991/2202577924924539/latest.html
# MAGIC    - https://databricks-prod-cloudfront.cloud.databricks.com/public/4027ec902e239c93eaaa8714f173bcfc/2799933550853697/1090810279282078/2202577924924539/latest.html
...
# MAGIC %md
# MAGIC ### Regular expressions 101 - By Rogelio Cuevas 
# MAGIC A regular expression (regex or regexp for short) is a special text string for describing a search pattern. A simple way of thinkinh of regular expressions is as wildcards on steroids; you may be familiar with wildcard notations such as *.txt to find all text files in a file manager. 
# MAGIC 
# MAGIC They are very useful to find and collect a specific type of pattern in a given string.
# MAGIC 
# MAGIC Python supports regular expressions through the re module. As you might have guessed by now this can be imported with:
...
# MAGIC %md
# MAGIC In Python a regular expression search is typically written as:
# MAGIC 
# MAGIC **match = re.search(pat, str)**
# MAGIC 
# MAGIC Here is a very simple of example of how to use regular expressions in Python
...
# MAGIC %md 
# MAGIC 
# MAGIC There are many resources to get familiar with regex and we encourage you to vist them. Here are some suggestions:
# MAGIC 
# MAGIC https://docs.python.org/2/library/re.html
# MAGIC 
# MAGIC http://regexone.com/references/python
# MAGIC 
# MAGIC https://developers.google.com/edu/python/regular-expressions
# MAGIC 
# MAGIC The following website is particularly useful as it allows you to test your regex online
# MAGIC 
# MAGIC https://regex101.com/#python
# MAGIC 
# MAGIC Finally, a very useful book on regex
# MAGIC 
# MAGIC Hint. For this lab you may want to check the following resource in order to implement the function that removes punctuation https://docs.python.org/2/library/re.html#re.sub
